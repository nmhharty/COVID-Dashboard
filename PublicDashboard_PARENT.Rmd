...
```{r, child = "../Shared Resources/Child Rmd Files/MostRecent2Weeks1WeekSummary_Table.Rmd"}
```
...
```{r, child = "../Shared Resources/Child Rmd Files/Incidence-SchoolAgeNonSchoolAge14dayRolling.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/Incidence-Weekly14dayRollingAvg.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/IncidenceReportDate.Rmd", eval = params$Internal}
```

```{r, child = "../Shared Resources/Child Rmd Files/Positivity.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/ResidentVisitorWeeklyCases.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/PCRdelay.Rmd"}
```
    
```{r, child = "../Shared Resources/Child Rmd Files/Outbreaks.Rmd"}
```
...
```{r, child = "../Shared Resources/Child Rmd Files/Surveillance-CaseOutcomes.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/Surveillance-Symptoms.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/Surveillance-ExposureTypeResidents.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/Surveillance-ExposureTypeVisitors.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/Surveillance-VaxEfficacy.Rmd"}
```

```{r, child = "../Shared Resources/Child Rmd Files/CICT Trends.Rmd", eval = params$Internal}
```

```{r, child = "../Shared Resources/Child Rmd Files/AllCasesSummary.Rmd"}
```
...
## Updates by Date  
**October 25, 2021**: Refactored underlying code for dashboard leading to minor updates throughout, using different source file from CDPHE for cases and tests.       
